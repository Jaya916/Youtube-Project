...
def get_channel_info(channel_id):
  ...
  for i in response["items"]:
    data=dict(Channel_Name=i["snippet"]["title"],
              ...
              Total_Viedos=i["statistics"]["videoCount"],
...
if question=="1.All the videos and the channel name":
...
elif question=="3.10 most viewed vodeos":
  query3='''select views as views,channel_name as channelname,title as videotitle from videos
              where views is not null order by views desc'''
  cursor.execute(query3)
  mydb.commit()
  t3=cursor.fetchall()
  df2=pd.DataFrame(t3,columns=["channelname","no_videos"])
  st.write(df2)
  ...
  query8='''select title as videotitle,published_date as videorelease,channel_name as channelname where
